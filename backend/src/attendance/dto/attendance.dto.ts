...
/**
 * A single correction made from the attendance history.
 *
 * The sheet is submitted once and then closes; anything that has to change
 * afterwards is changed one student at a time from the record, which is what
 * this carries.
 */
