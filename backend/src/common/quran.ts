...
/**
 * The examination programme, ordered the way circles teach it: students start
 * from Juz' 30 (the short surahs) and work backwards to Juz' 1.
 */
export const EXAM_SECTIONS = Array.from({ length: 30 }, (_, i) => {
  const juz = 30 - i;
  return {
