...
export class ParentsController {
  ...
  /**
   * Names and phone numbers only, for the "link a guardian" picker on the
   * student form. Teachers register students into their own circles, so they
   * need it too — without it the dropdown is empty and a new student cannot be
   * attached to their father at all.
   */
  @Get('options')
