...
export function RequireAuth({ children }: { children: ReactNode }) {
  ...
  // An account still carrying the password the management set is held on the
  // profile page until the user picks their own. Without this the prompt is
  // trivially clicked past and the shared password stays in use.
