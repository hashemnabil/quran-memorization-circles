      ...
      >
        {settings?.logoUrl ? (
          <img
            ...
            alt=""
            className="h-10 w-10 shrink-0 rounded-xl bg-white/10 object-contain p-1"
          />
        ) : (
          <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white/10 text-gold-300">
            <IconMosque size={22} />
          </span>
        )}
